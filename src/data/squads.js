// Generated from https://en.wikipedia.org/wiki/2026_FIFA_World_Cup_squads
// Positions use app labels: ARQ, DEF, MED, DEL.
export const squadSourceUrl = 'https://en.wikipedia.org/wiki/2026_FIFA_World_Cup_squads'

export const countrySquads = {
  "Czechia": [
    {
      "no": 1,
      "name": "Matěj Kovář",
